...
try {
    ...
    & (Join-Path $PSScriptRoot "..\..\scripts\Reset.ps1")
    & (Join-Path $PSScriptRoot "..\..\scripts\Prepare-Fixtures.ps1")
    & (Join-Path $PSScriptRoot "..\..\scripts\Build-MeasureHelper.ps1")
    & (Join-Path $PSScriptRoot "..\..\scripts\Capture-Baselines.ps1") -BinaryPath $BinaryPath
