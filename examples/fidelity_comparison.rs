...
use clean_ctx::compression::{Fidelity, compress_file};
...
fn generate_edit_sequence() -> Vec<(String, EditCategory, String)> {
    ...
    let base_source =
        std::fs::read_to_string(&base_path).expect("Cannot read UserManagementService.ts");
    ...
    results.push((
        "Rename 'apiBasePath' to 'baseApiPath'".to_string(),
        EditCategory::Small,
        current.clone(),
    ));
    ...
    results.push((
        "Add void return type to logOperation".to_string(),
        EditCategory::Small,
        current.clone(),
    ));
    ...
    results.push((
        "Rename 'isActive' to 'active' in UserFilter".to_string(),
        EditCategory::Small,
        current.clone(),
    ));
    ...
    results.push((
        "Change defaultPageSize from 25 to 50".to_string(),
        EditCategory::Small,
        current.clone(),
    ));
    ...
    results.push((
        "Add null coalesce to getLastError return".to_string(),
        EditCategory::Small,
        current.clone(),
    ));
    ...
    results.push((
        "Change cache TTL from 5min to 10min".to_string(),
        EditCategory::Small,
        current.clone(),
    ));
    ...
    results.push((
        "Add activeRequests counter field".to_string(),
        EditCategory::Small,
        current.clone(),
    ));
    ...
    results.push((
        "Rename isAuthenticated to hasActiveSession".to_string(),
        EditCategory::Small,
        current.clone(),
    ));
    ...
    results.push((
        "Add X-Request-ID header to buildHeaders".to_string(),
        EditCategory::Small,
        current.clone(),
    ));
    ...
    results.push((
        "Add trim() to displayName validation".to_string(),
        EditCategory::Small,
        current.clone(),
    ));
    ...
    results.push((
        "Add getUserPermissions method".to_string(),
        EditCategory::Method,
        current.clone(),
    ));
    ...
    results.push((
        "Add batchSize param to batchCreateUsers".to_string(),
        EditCategory::Method,
        current.clone(),
    ));
    ...
    results.push((
        "Add optional fields param to getUserById".to_string(),
        EditCategory::Method,
        current.clone(),
    ));
    ...
    results.push((
        "Change verifyEmail return type to object".to_string(),
        EditCategory::Method,
        current.clone(),
    ));
    ...
    results.push((
        "Add AbortController timeout to getUsers".to_string(),
        EditCategory::Method,
        current.clone(),
    ));
    ...
    results.push((
        "Add caching logic to getUserByEmail".to_string(),
        EditCategory::Method,
        current.clone(),
    ));
    ...
    results.push((
        "Change updateUser from PUT to PATCH".to_string(),
        EditCategory::Method,
        current.clone(),
    ));
    ...
    results.push((
        "Add Promise.allSettled for batch error handling".to_string(),
        EditCategory::Method,
        current.clone(),
    ));
    ...
    results.push((
        "Add LoggerService constructor dependency".to_string(),
        EditCategory::Method,
        current.clone(),
    ));
    ...
    results.push((
        "Change maxPageSize from 100 to 200".to_string(),
        EditCategory::Method,
        current.clone(),
    ));
    ...
    results.push((
        "Add UserSession interface".to_string(),
    ...
    results.push((
        "Add SessionToken and IPAddress type aliases".to_string(),
        EditCategory::Structural,
        current.clone(),
    ));
    ...
    results.push((
        "Add @Input() serviceConfig field".to_string(),
        EditCategory::Structural,
        current.clone(),
    ));
    ...
    results.push((
        "Split validateUserData into helper methods".to_string(),
        EditCategory::Structural,
        current.clone(),
    ));
    ...
    results.push((
        "Add @Output() errorOccurred EventEmitter".to_string(),
        EditCategory::Structural,
        current.clone(),
    ));
    ...
    results.push((
        "Add suspendUser method".to_string(),
        EditCategory::Structural,
        current.clone(),
    ));
    ...
    results.push((
        "Add rate limiting fields".to_string(),
        EditCategory::Structural,
        current.clone(),
    ));
    ...
    results.push((
        "Add getAllUsers convenience method".to_string(),
        EditCategory::Structural,
        current.clone(),
    ));
    ...
    results.push((
        "Add logMethodEntry and logMethodExit helpers".to_string(),
        EditCategory::Structural,
        current.clone(),
    ));
    ...
    results.push((
        "Add UserServiceConfig interface".to_string(),
        EditCategory::Structural,
        current.clone(),
    ));
    ...
    results.push((
        "Extract buildUrl URL builder method".to_string(),
        EditCategory::CrossMethod,
        current.clone(),
    ));
    ...
    results.push((
        "Add try/catch to getFromCache".to_string(),
        EditCategory::CrossMethod,
        current.clone(),
    ));
    ...
    results.push((
        "Add try/catch to setInCache".to_string(),
        EditCategory::CrossMethod,
        current.clone(),
    ));
    ...
    results.push((
        "Add withRetry and delay cross-method helpers".to_string(),
        EditCategory::CrossMethod,
        current.clone(),
    ));
    ...
    results.push((
        "Add throwIfNotAuthenticated guard method".to_string(),
        EditCategory::CrossMethod,
        current.clone(),
    ));
    ...
    results.push((
        "Add measure() timing wrapper".to_string(),
        EditCategory::CrossMethod,
        current.clone(),
    ));
    ...
    results.push((
        "Add ConfigService constructor dependency".to_string(),
        EditCategory::CrossMethod,
        current.clone(),
    ));
    ...
    results.push((
        "Add rate limiting logic to incrementRequestCount".to_string(),
        EditCategory::CrossMethod,
        current.clone(),
    ));
    ...
    results.push((
        "Add cache_set operation logging".to_string(),
        EditCategory::CrossMethod,
        current.clone(),
    ));
    ...
    results.push((
        "Emit errorOccurred event in handleError".to_string(),
        EditCategory::CrossMethod,
        current.clone(),
    ));
    ...
    results.push((
        "Add RequestOptions object to getUsers signature".to_string(),
        EditCategory::Refactor,
        current.clone(),
    ));
    ...
    results.push((
        "Add RequestOptions interface".to_string(),
        EditCategory::Refactor,
        current.clone(),
    ));
    ...
    results.push((
        "Refactor constructor to use UserServiceConfig options object".to_string(),
        EditCategory::Refactor,
        current.clone(),
    ));
    ...
    results.push((
        "Add UserOperationResult<T> generic interface".to_string(),
        EditCategory::Refactor,
        current.clone(),
    ));
    ...
    results.push((
        "Replace ApiResponse with UserOperationResult in all signatures".to_string(),
        EditCategory::Refactor,
        current.clone(),
    ));
    ...
    results.push((
        "Add Configuration region comment".to_string(),
        EditCategory::Refactor,
        current.clone(),
    ));
    ...
    results.push((
        "Add Public API Methods region header".to_string(),
        EditCategory::Refactor,
        current.clone(),
    ));
    ...
    results.push((
        "Add Private Helper Methods region header".to_string(),
        EditCategory::Refactor,
        current.clone(),
    ));
    ...
    results.push((
        "Add recoveryStrategy param to handleError".to_string(),
        EditCategory::Refactor,
        current.clone(),
    ));
    ...
    results.push((
        "Add executeSafely error boundary wrapper".to_string(),
        EditCategory::Refactor,
        current.clone(),
    ));
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    for run in &[&low, &medium, &high] {
        let re_pct = if run.total_raw > 0 {
            (run.total_raw.saturating_sub(run.total_recomp)) as f64 / run.total_raw as f64 * 100.0
        } else {
            0.0
        };
        let del_pct = if run.total_raw > 0 {
            (run.total_raw.saturating_sub(run.total_delta)) as f64 / run.total_raw as f64 * 100.0
        } else {
            0.0
        };
        let del_vs_re_pct = if run.total_recomp > 0 {
            (run.total_recomp.saturating_sub(run.total_delta)) as f64 / run.total_recomp as f64
                * 100.0
        } else {
            0.0
        };
    ...
    for run in &[&low, &medium, &high] {
        ...
        let pct = if first.raw_cost > 0 {
            (first.raw_cost.saturating_sub(first.recompression_cost)) as f64 / first.raw_cost as f64
                * 100.0
        } else {
            0.0
        };
        let ratio = if first.recompression_cost > 0 {
            first.raw_cost as f64 / first.recompression_cost as f64
        } else {
            0.0
        };
        println!(
    ...
    let cats = [
        ...
        (EditCategory::Structural, "Struct"),
        (EditCategory::CrossMethod, "Cross"),
    ...
    for (cat, label) in &cats {
        ...
        let calc_sav = |run: &FidelityRun| -> (f64, f64) {
            ...
            let del: usize = run
                ...
                .sum();
            let rep = if raw > 0 {
                (raw.saturating_sub(re)) as f64 / raw as f64 * 100.0
            } else {
                0.0
            };
            let delp = if raw > 0 {
                (raw.saturating_sub(del)) as f64 / raw as f64 * 100.0
            } else {
                0.0
            };
            (rep, delp)
        ...
        println!(
            "  {:<10} {:>10} {:>9.1}% {:>9.1}% {:>9.1}% {:>9.1}% {:>9.1}% {:>9.1}% {:>10}",
    ...
    println!(
        "  Compression Ratio (Raw/ReComp):  Low={:.0}×  Medium={:.0}×  High={:.0}×",
        low_ratio, med_ratio, hi_ratio
    );

    // Delta overhead percentage
    let low_del_overhead = if low.total_recomp > 0 {
        (low.total_delta.saturating_sub(low.total_recomp)) as f64 / low.total_recomp as f64 * 100.0
    } else {
        0.0
    };
    let med_del_overhead = if medium.total_recomp > 0 {
        (medium.total_delta.saturating_sub(medium.total_recomp)) as f64 / medium.total_recomp as f64
            * 100.0
    } else {
        0.0
    };
    let hi_del_overhead = if high.total_recomp > 0 {
        (high.total_delta.saturating_sub(high.total_recomp)) as f64 / high.total_recomp as f64
            * 100.0
    } else {
        0.0
    };
    println!(
        "  Delta Overhead vs Full ReComp:    Low={:+.1}%  Medium={:+.1}%  High={:+.1}%",
        low_del_overhead, med_del_overhead, hi_del_overhead
    );

    // Average per-edit tokens
    println!(
        "  Avg Tokens/Edit (ReComp):          Low={:.1}  Medium={:.1}  High={:.1}",
        low.total_recomp as f64 / 50.0,
        medium.total_recomp as f64 / 50.0,
        high.total_recomp as f64 / 50.0
    );
    println!(
        "  Avg Tokens/Edit (Delta):           Low={:.1}  Medium={:.1}  High={:.1}",
        low.total_delta as f64 / 50.0,
        medium.total_delta as f64 / 50.0,
        high.total_delta as f64 / 50.0
    );
    ...
    for run in &[&low, &medium, &high] {
        ...
        let del_pct = if first.raw_cost > 0 {
            (first.raw_cost.saturating_sub(first.delta_cost)) as f64 / first.raw_cost as f64 * 100.0
        } else {
            0.0
        };
        println!(
            "    {}: Raw={} ReComp={} ({:.1}%) Delta={} ({:.1}%)",
    ...
    println!();
    println!(
        "  Simulation Runtime:                Low={:.2}s  Medium={:.2}s  High={:.2}s",
