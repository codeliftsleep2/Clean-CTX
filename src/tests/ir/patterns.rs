...
fn modifiers(tid: &str, values: &[DeclarationModifier]) -> CoreOp {
    CoreOp::MethodModifiers(tid.into(), values.to_vec())
}
...
#[path = "patterns_pipeline.rs"]
mod pipeline;

#[path = "patterns_pipeline_extended.rs"]
mod pipeline_extended;
