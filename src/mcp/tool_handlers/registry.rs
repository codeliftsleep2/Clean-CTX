...
pub fn create_default_registry() -> HandlerRegistry {
    ...
    register_tool!(reg, "context_history", Box::new(|id, params, state| {
    ...
    register_tool!(reg, "context_stats", Box::new(|id, params, state| {
    ...
    register_tool!(reg, "save_context", Box::new(|id, params, state| {
        crate::mcp::tool_handlers::persistence::handle_save_context(id, params, state);
    }));
    register_tool!(reg, "list_sessions", Box::new(|id, params, state| {
        crate::mcp::tool_handlers::persistence::handle_list_sessions(id, params, state);
    }));
    register_tool!(reg, "replay_history", Box::new(|id, params, state| {
        crate::mcp::tool_handlers::persistence::handle_replay_history(id, params, state);
    }));
    register_tool!(reg, "purge_old_deltas", Box::new(|id, params, state| {
