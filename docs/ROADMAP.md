...
|----|-------|-------------|-------:|---------:|
| **R-22** | Angular Meta-Layer | Framework-annotation layer for Angular files. Phase 1 ✅ (Tier 1: decorator extraction). Phase 2 📋 (file-triplet bundling). Phase 3 📋 (cross-file DI graph). | 3.5 days | 🟡 Medium |
