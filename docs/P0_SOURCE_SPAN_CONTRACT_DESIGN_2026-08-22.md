...
**Audience:** Architectural review gate before implementation
...
|---|---|---|---|
| IR path (`MetaLayerPass`) | ZERO markers | ZERO markers | ZERO markers |
| Text path (compress) | WORKS (Angular-only fix) | ZERO markers | ZERO markers |
