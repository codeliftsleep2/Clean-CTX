...
| Tests | ✅ **2,507 tests across all workspace targets (2,167 core library), all passing** - includes live-CBM semantic probes, a self-contained multilingual fixture suite, and 18 round-trip wire-format tests |
